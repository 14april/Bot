...
@bot.tree.command(name="buff_xp", description="[OWNER ONLY] Thêm XP cho người dùng để kiểm tra hệ thống.",default_permissions=discord.app_commands.Permissions(administrator=True))
...
@bot.tree.command(name="buff", description="[OWNER ONLY] Thêm Fund/Coupon cho người chơi.",default_permissions=discord.app_commands.Permissions(administrator=True))
@app_commands.describe(
